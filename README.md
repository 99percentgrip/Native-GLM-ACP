...
To pin a release, set `GLM_ACP_VERSION=v2.6.1` before running the Unix
installer, or pass `-Version v2.6.1` to the downloaded PowerShell script.
The current release and manual-download fallback is
[v2.6.1](https://github.com/99percentgrip/Native-GLM-ACP/releases/tag/v2.6.1).
...
# expect: glm_acp-2.6.1.dist-info  (and editable-install metadata)
```
