...
To pin a release, set `GLM_ACP_VERSION=v1.8.6` before running the Unix
installer, or pass `-Version v1.8.6` to the downloaded PowerShell script.
The current release and manual-download fallback is
[v1.8.6](https://github.com/99percentgrip/Native-GLM-ACP/releases/tag/v1.8.6).
...
# expect: glm_acp-1.8.6.dist-info  (and editable-install metadata)
```
