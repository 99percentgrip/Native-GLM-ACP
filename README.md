...
To pin a release, set `GLM_ACP_VERSION=v1.9.8` before running the Unix
installer, or pass `-Version v1.9.8` to the downloaded PowerShell script.
The current release and manual-download fallback is
[v1.9.8](https://github.com/99percentgrip/Native-GLM-ACP/releases/tag/v1.9.8).
...
# expect: glm_acp-1.9.8.dist-info  (and editable-install metadata)
```
