...
To pin a release, set `GLM_ACP_VERSION=v1.9.5` before running the Unix
installer, or pass `-Version v1.9.5` to the downloaded PowerShell script.
The current release and manual-download fallback is
[v1.9.5](https://github.com/99percentgrip/Native-GLM-ACP/releases/tag/v1.9.5).
...
# expect: glm_acp-1.9.5.dist-info  (and editable-install metadata)
```
