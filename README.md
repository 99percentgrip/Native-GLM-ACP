...
To pin a release, set `GLM_ACP_VERSION=v2.7.22` before running the Unix
installer, or pass `-Version v2.7.22` to the downloaded PowerShell script.
The current release and manual-download fallback is
[v2.7.22](https://github.com/99percentgrip/Native-GLM-ACP/releases/tag/v2.7.22).
...
# expect: glm_acp-2.7.22.dist-info  (and editable-install metadata)
```
