...
To pin a release, set `GLM_ACP_VERSION=v1.9.0` before running the Unix
installer, or pass `-Version v1.9.0` to the downloaded PowerShell script.
The current release and manual-download fallback is
[v1.9.0](https://github.com/99percentgrip/Native-GLM-ACP/releases/tag/v1.9.0).
...
# expect: glm_acp-1.9.0.dist-info  (and editable-install metadata)
```
